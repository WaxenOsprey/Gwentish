  ...
  const Hand = ({activePlayer, setActivePlayer, listOf2Players}) => {
      ...
      return (
        <>
          {!isRoundOverModal && ( 
            <HandWrapper activePlayer={activePlayer} listOf2Players={listOf2Players}>
              <PlayerPrompt activePlayer={activePlayer} listOf2Players={listOf2Players}>{activePlayer.name + ': ' + 'Choose your Card!'}</PlayerPrompt>
              <HandContainer>
